...
### 2.1 ⭐⭐ 13 BƯỚC BEST PATH SELECTION
...
### 2.2 ⭐⭐ ĐIỀU KHIỂN HƯỚNG TRAFFIC — bảng quan trọng nhất module
...
### 2.9 ⭐ `aggregate-address` — summarization của BGP
...
### 3.1 13 bước như quy trình đấu thầu
...
### 3.2 Vì sao "inbound chỉ là gợi ý"
...
### 3.3 `no-export` vs `no-advertise` — hai mức bí mật
...
### 3.4 Prefix-list `0.0.0.0/0` vs `0.0.0.0/0 le 32`
...
### 3.5 `aggregate-address` như đóng thùng hàng
