...
| [Module-04B-OSPF-Area-Summarization-OSPFv3.md](Module-04B-OSPF-Area-Summarization-OSPFv3.md)<br>+ 🧪 [**Module-04B-LAB.md**](Module-04B-LAB.md) | LSA 4–5–7, **area type** (stub/NSSA), **summarization**, filtering, virtual-link, auth, OSPFv3<br>⭐ **Có trang TÓM TẮT 10 phút + bố cục 4 phần + LAB tách riêng** | Tuần 8 |
| [Module-05A-BGP-Nen-tang-va-eBGP-Peering.md](Module-05A-BGP-Nen-tang-va-eBGP-Peering.md)<br>+ 🧪 [**Module-05A-LAB.md**](Module-05A-LAB.md) | eBGP peering, 6 neighbor state, 3 bảng BGP, `network` statement, attribute<br>⭐ **Có trang TÓM TẮT 10 phút + bố cục 4 phần + LAB tách riêng** | Tuần 9 |
| [Module-05B-BGP-Path-Selection-va-Filtering.md](Module-05B-BGP-Path-Selection-va-Filtering.md)<br>+ 🧪 [**Module-05B-LAB.md**](Module-05B-LAB.md) | ⭐ **13 bước path selection**, Weight/LocPref/prepend/MED, community, filtering, `aggregate-address`<br>⭐ **Có trang TÓM TẮT 10 phút + bố cục 4 phần + LAB tách riêng** | Tuần 10 |
| [Module-06A-FHRP-HSRP-VRRP-GLBP.md](Module-06A-FHRP-HSRP-VRRP-GLBP.md)<br>+ 🧪 [**Module-06A-LAB.md**](Module-06A-LAB.md) | HSRP/VRRP/GLBP, ⭐ **object tracking + IP SLA**, SSO/NSF/StackWise<br>⭐ **Có trang TÓM TẮT 10 phút + bố cục 4 phần + LAB tách riêng** | Tuần 11 |
| [Module-06B-NAT-NTP-Multicast.md](Module-06B-NAT-NTP-Multicast.md)<br>+ 🧪 [**Module-06B-LAB.md**](Module-06B-LAB.md) | NAT/PAT nâng cao, ⭐ **thứ tự NAT–routing**, NAT dual-ISP, NTP, Multicast (IGMP/PIM)<br>⭐ **Có trang TÓM TẮT 10 phút + bố cục 4 phần + LAB tách riêng** | Tuần 11 |
...
| [Module-07B-CAPWAP-WLC-FlexConnect-Roaming.md](Module-07B-CAPWAP-WLC-FlexConnect-Roaming.md)<br>+ 🧪 [**Module-07B-LAB.md**](Module-07B-LAB.md) | Split-MAC, CAPWAP 5246/5247, ⭐ **AP join & discovery & WLC selection**, FlexConnect, ⭐ **roaming L2/L3 anchor-foreign**, ⭐ **troubleshoot 6 tầng**<br>⭐ **TÓM TẮT 10 phút + 4 phần + LAB riêng** | Tuần 13 |
| [Module-08-Virtualization-va-Overlay.md](Module-08-Virtualization-va-Overlay.md)<br>+ 🧪 [**Module-08-LAB.md**](Module-08-LAB.md) | Hypervisor/vSwitch (EST/VST/VGT), ⭐ **VRF-lite**, ⭐ **GRE**, ⭐ **IPsec & GRE over IPsec**, LISP, VXLAN<br>⭐ **TÓM TẮT 10 phút + 4 phần + LAB riêng** | Tuần 14 |
| [Module-09-Architecture-va-QoS.md](Module-09-Architecture-va-QoS.md)<br>+ 🧪 [**Module-09-LAB.md**](Module-09-LAB.md) | 2-tier/3-tier, Spine-Leaf, HA (SSO/NSF/GR), WLAN design, cloud, ⭐ **SD-WAN**, ⭐ **SD-Access**, ⭐ **QoS**<br>⭐ **TÓM TẮT 10 phút + 4 phần + LAB riêng** | Tuần 15 |
...
Mỗi module chia thành **4 phần đọc tuần tự + 1 phụ lục tra cứu**. Bạn luôn biết mình đang ở đâu:

| Phần | Tên | Trả lời câu hỏi | Đọc thế nào |
|:---:|---|---|---|
| 📌 | **TÓM TẮT** | Module này giải quyết chuyện gì? | **Đọc 10 phút là nắm khung.** 1 câu hỏi trung tâm · 1 sơ đồ toàn cảnh · 5–7 ý phải nhớ · bảng lệnh cốt lõi |
| **1** | 🧠 **CÁI ĐÓ LÀ GÌ** | *"À, ra nó là thế"* | Đọc **một mạch**. Toàn ví von đời thường, **không lệnh, không bảng tra** |
| **2** | ⚙️ **NÓ CHẠY THẾ NÀO** | Cơ chế thật + tên gọi kỹ thuật | Đọc kỹ, đối chiếu sơ đồ. Mỗi mục **nối ngược** về một ví von ở Phần 1 |
| **3** | 🧪 **NHÌN THẤY NÓ** | Gõ tay, thấy tận mắt | **File LAB riêng** — config đầy đủ dán là chạy |
| **4** | 🏗️ **TOPO & KIẾN TRÚC** | *"Nó nằm ở đâu trong mạng thật?"* | Sơ đồ + bảng quyết định thiết kế + **bài tập vẽ lại trên giấy** |
| 📎 | **PHỤ LỤC** | Tra cứu | 🔴 **KHÔNG đọc lần đầu.** Bẫy đề · quiz · thuật ngữ · gỡ lỗi — chỉ Ctrl+F khi cần |

### Nhịp của mỗi bước trong file LAB

Mọi bước lab đều theo đúng một nhịp, để bạn không phải đoán:

> **🎯 Mục tiêu** → **Gõ gì** → **Sẽ thấy gì** → **💡 Vì sao** → **✅ Checkpoint**

Kèm: bảng để bạn **tự điền**, đáp án gấp trong `<details>`, và **bước dọn dẹp bắt buộc** nếu lab có
thay đổi nguy hiểm (tắt CEF, shutdown link…).

### Ba nguyên tắc biên soạn

| # | Nguyên tắc |
|:---:|---|
| 1 | **Bảng biểu không phải để học, mà để tra** → nên chúng nằm ở Phần 2 và Phụ lục, không phải Phần 1 |
...
> ⚙️ **Tình trạng chuyển đổi:** các module **P0, 01, 02, 03, 04A, 04B, 05A, 05B, 06A, 06B, 07A, 07B, 08, 09** đã theo khuôn này.
